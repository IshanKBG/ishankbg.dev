...
Also I would like to mention that Rust has raw pointers, which can be **dangling** but you need an [`unsafe`](https://doc.rust-lang.org/book/ch19-01-unsafe-rust.html) block to use them.
